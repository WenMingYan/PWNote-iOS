...
#import "TYSmartActionDialogTimerTableView.h"
#import "TYSmartActionDialogTimerPickerColumnCell.h"
#import "TYDeviceFunctionDefine.h"
#import "UIView+ALMAdditons.h"

@interface TYSmartActionDialogTimerPickerColumnView () <UITableViewDelegate, UITableViewDataSource>
...
@property (nonatomic, weak) TYSmartActionDialogTimerTableView *upTableView;
@property (nonatomic, weak) TYSmartActionDialogTimerTableView *centerTableView;
@property (nonatomic, weak) TYSmartActionDialogTimerTableView *downTableView;
...
@implementation TYSmartActionDialogTimerPickerColumnView
...
- (void)setupTableView {
    {
        ...
        TYSmartActionDialogTimerTableView *tableView = [[TYSmartActionDialogTimerTableView alloc]initWithFrame:frame style:UITableViewStylePlain];
        [tableView registerClass:[TYSmartActionDialogTimerPickerColumnCell class] forCellReuseIdentifier:cellReuseIdentifier];
...
- (void)scrollViewDidScroll:(UITableView *)tableView {
    ...
    if (tableView == self.downTableView) {
        ...
        if (!self.isHiddenWheels) {
            [tableView.visibleCells enumerateObjectsUsingBlock:^(__kindof TYSmartActionDialogTimerPickerColumnCell * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TYSmartActionDialogTimerPickerColumnCell *cell = [tableView dequeueReusableCellWithIdentifier:cellReuseIdentifier];
